...
class WebSocketAppTest(unittest.TestCase):
	...
	def testKeepRunning(self):
		...
		app = ws.WebSocketApp('ws://127.0.0.1:' + LOCAL_WS_SERVER_PORT, on_open = on_open, on_close = on_close,
	...
	def testInvalidPingIntervalPingTimeout(self):
		...
		self.assertRaises(ws.WebSocketException, app.run_forever, ping_interval = 1, ping_timeout = 2,
	...
	def testBadPingInterval(self):
		...
		self.assertRaises(ws.WebSocketException, app.run_forever, ping_interval = -5,
		                  sslopt = { "cert_reqs": ssl.CERT_NONE })
	...
	def testBadPingTimeout(self):
		...
		"""
		app = ws.WebSocketApp('wss://api-pub.bitfinex.com/ws/1')
		self.assertRaises(ws.WebSocketException, app.run_forever, ping_timeout = -3,
		                  sslopt = { "cert_reqs": ssl.CERT_NONE })
